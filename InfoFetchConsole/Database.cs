...
namespace InfoFetch
{
    class Database
    {
        ...
        public void Update()
        {
            ...
            {
                MyNotification.Push(InfoFetchConsole.Program.localeM.GetString("DatabaseChange"), InfoFetchConsole.Program.localeM.GetString("DatabaseOldDelete") + "\nURL: " + url);
                cmd.Reset();
        ...
        public void Compare(string url, string content, string date)
        {
            ...
            {
                MyNotification.Push(url, content, date);
